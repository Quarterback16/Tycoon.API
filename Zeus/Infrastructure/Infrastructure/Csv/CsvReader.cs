...
namespace Employment.Web.Mvc.Infrastructure.Csv
{
	...
	public class CsvReader : ICsvReader
	{
		...
		/// <summary>
        /// Invalidates the record cache for the given type. After <see cref="ICsvReaderRow.GetRecord{T}"/> is called the
        ...
        /// changes, <see cref="ICsvReaderRow.InvalidateRecordCache{T}"/> needs to be called to updated the
		/// record cache.
		/// </summary>
