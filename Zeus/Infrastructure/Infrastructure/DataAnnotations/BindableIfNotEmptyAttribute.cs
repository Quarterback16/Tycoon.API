...
namespace Employment.Web.Mvc.Infrastructure.DataAnnotations
{
    ...
    /// </summary>
    public class BindableIfNotEmptyAttribute : ContingentAttribute
    {
        /// <summary>
        /// User service.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BindableIfNotEmptyAttribute" /> class.
        /// </summary>
        /// <remarks>
        /// This constructor implies the dependent property is the property decorated with this attribute (self-referencing).
        /// </remarks>
        public BindableIfNotEmptyAttribute() : base(ActionForDependencyType.Bindable, null)
        {
        ...
        public BindableIfNotEmptyAttribute(string dependentProperty) : base(ActionForDependencyType.Bindable, dependentProperty)
        {
            ComparisonType = ComparisonType.NotEqualTo;
        }
