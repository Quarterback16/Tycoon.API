...
{
    /// <summary>
    /// Represents an attribute that is used to determine whether the property is read only based on if the value of a dependent property is empty.
    /// </summary>
    public class ReadOnlyIfEmptyAttribute : ContingentAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadOnlyIfEmptyAttribute" /> class.
        /// </summary>
        /// <remarks>
        /// This constructor implies the dependent property is the property decorated with this attribute (self-referencing).
        /// </remarks>
        public ReadOnlyIfEmptyAttribute() : base(ActionForDependencyType.Disabled, null) { }

        /// <summary>
        /// Initializes a new instance of the <see cref="ReadOnlyIfEmptyAttribute" /> class.
        /// </summary>
        /// <param name="dependentProperty">The dependent property in the model that this object is dependent on.</param>
        public ReadOnlyIfEmptyAttribute(string dependentProperty) : base(ActionForDependencyType.Disabled, dependentProperty) { }
