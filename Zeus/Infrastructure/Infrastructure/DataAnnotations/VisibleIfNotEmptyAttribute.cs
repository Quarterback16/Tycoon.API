...
{
    /// <summary>
    /// Represents an attribute that is used to determine whether the property is visible based on if the value of a dependent property is not empty.
    /// </summary>
    public class VisibleIfNotEmptyAttribute : ContingentAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VisibleIfNotEmptyAttribute" /> class.
        /// </summary>
        /// <remarks>
        /// This constructor implies the dependent property is the property decorated with this attribute (self-referencing).
        /// </remarks>
        public VisibleIfNotEmptyAttribute() : base(ActionForDependencyType.Visible, null)
        {
        ...
        public VisibleIfNotEmptyAttribute(string dependentProperty) : base(ActionForDependencyType.Visible, dependentProperty)
        {
            ComparisonType = ComparisonType.NotEqualTo;
        }
