...
{
    /// <summary>
    /// Represents an attribute that is used to determine whether the property is read only based on if the value of a dependent property is not empty.
    /// </summary>
    public class ReadOnlyIfNotEmptyAttribute : ContingentAttribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadOnlyIfNotEmptyAttribute" /> class.
        /// </summary>
        /// <remarks>
        /// This constructor implies the dependent property is the property decorated with this attribute (self-referencing).
        /// </remarks>
        public ReadOnlyIfNotEmptyAttribute() : base(ActionForDependencyType.Disabled, null)
        {
        ...
        public ReadOnlyIfNotEmptyAttribute(string dependentProperty) : base(ActionForDependencyType.Disabled, dependentProperty)
        {
            ComparisonType = ComparisonType.NotEqualTo;
        }
