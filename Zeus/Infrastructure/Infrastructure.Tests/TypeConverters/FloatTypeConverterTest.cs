...
{
    /// <summary>
    /// Unit tests for <see cref="FloatTypeConverter" />.
    ///</summary>
    [TestClass]
    public class FloatTypeConverterTest
    {
        ...
        ///</summary>
        [TestMethod]
        public void FloatTypeConverter_ConvertCoreWithValidString_Converts()
        {

            float number = 5;
            string source = number.ToString();

            var result = FloatTypeConverter.Convert(source);
        ...
        ///</summary>
        [TestMethod]
        public void FloatTypeConverter_ConvertCoreWithNullString_Converts()
        {
        ...
        ///</summary>
        [TestMethod]
        public void FloatTypeConverter_ConvertCoreWithEmptyString_Converts()
        {
