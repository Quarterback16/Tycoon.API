...
{
    [DisplayName(".....")]
    [Group("Footable Editable Exp", Order = 1)]
    public class FootableEditableViewModelExp
    {
        [Display(GroupName = "Footable Editable Exp", Order = 1)]
...
");
        ...
        /// 
        /// </summary>
        [Display(GroupName = "Footable Editable Exp", Order = 2)]
        [DataType(CustomDataType.GridEditable)]
        [FooTable]
        [Editable(true)]
        [AjaxGrid("Example", "SaveGridExpData", "Tables")]
        [ReferenceList("FootableRows_Countries", "Id", "Name")]
        public IEnumerable<FootableEditableDemoRowExp> FootableRows { get; set; }


        #region Reference data properties

        [Hidden(ExcludeFromView = true)]
        public IEnumerable<Country> FootableRows_Countries { get; set; }


        #endregion


        [Display(GroupName = "Footable Editable Exp", Order = 3)]
