...
namespace Employment.Web.Mvc.Area.Calendar.Tests
{
    /// <summary>
    /// Unit tests for <see cref="CalendarAreaRegistration" />.
    /// </summary>
    [TestClass]
    public class CalendarAreaRegistrationTest
    {
        private CalendarAreaRegistration SystemUnderTest()
        {
            return new CalendarAreaRegistration();
        }

        /// <summary>
        /// Test Calendar Area Registration is named correctly.
        /// </summary>
        [TestMethod]
        public void CalendarAreaRegistration_Valid_AreaNameIsCalendar()
        {
            var area = "Calendar";
        ...
        /// <summary>
        /// Test Calendar Area Registration returns a valid route when a http request is made to it.
        /// </summary>
        [TestMethod]
        public void CalendarAreaRegistration_HttpRequestMadeToArea_ReturnsValidRoute()
        {
            var area = "Calendar";
            var areaRegistration = SystemUnderTest();
