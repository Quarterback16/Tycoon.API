...
(function ($) {
    ...
    $.fn.sortsTable = function (tableToSort, columnToSort, sortFunctions, isResort) {
        ...
        if ($this !== undefined && $table !== undefined) {
            ...
            $table.find('th').slice(0, $($this).index()).each(function () {        // determines the index of current column.
    ...
    $.fn.sortTable.default_sort_functions =
        {
            ...
            "date": function (a, b) {
                ...
                aDateValue = $.fn.sortTable.getDateDDMMYYYY(a);
                bDateValue = $.fn.sortTable.getDateDDMMYYYY(b);
