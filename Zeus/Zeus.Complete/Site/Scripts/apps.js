...
var handleSidebarMenu = function() {
  ...
  $('.sidebar .nav > .has-sub > a').click(function() {
    ...
    var otherMenu = '.sidebar .slimScrollDiv .NavScrollDiv .nav > li.has-sub > .sub-menu';
  ...
  $('.sidebar .nav > .has-sub .sub-menu li.has-sub > a').click(function() {// .slimScrollDiv .NavScrollDiv
      if ($('.page-sidebar-minified').length === 0) {
          var target = $(this).next('.sub-menu');
          $(target).slideToggle(250);
      }
...
var handleThemePanelExpand = function() {
    $('[data-click="theme-panel-expand"]').live('click', function() {
        var targetContainer = $(this).closest('.theme-panel');
