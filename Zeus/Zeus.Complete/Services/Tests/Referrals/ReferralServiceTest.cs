...
using Employment.Esc.JobSeekerDisadvantages.Contracts.DataContracts;
using Employment.Esc.JobSeekerDisadvantages.Contracts.ServiceContracts;
using Employment.Esc.Provider.Contracts.DataContracts;
using Employment.Esc.Provider.Contracts.ServiceContracts;
...
using Employment.Web.Mvc.Service.Interfaces.Referrals.Common;
using Employment.Web.Mvc.Service.Interfaces.Referrals.Exceptions;
using Employment.Web.Mvc.Service.Interfaces.Referrals.Models;
using Employment.Web.Mvc.Service.Interfaces.Referrals.Models.Jca;
using Employment.Web.Mvc.Service.Interfaces.Referrals.Models.Jobseeker;
using Microsoft.Practices.EnterpriseLibrary.Validation.Integration.WCF;
using ClientExecutionMessage = Employment.Web.Mvc.Service.Interfaces.Referrals.Common.ClientExecutionMessage;
using Constants = Employment.Web.Mvc.Service.Interfaces.Referrals.Common.Constants;
using IClientExecution = Employment.Web.Mvc.Service.Interfaces.Referrals.Common.IClientExecution;
using NoClientResultException = Employment.Web.Mvc.Service.Interfaces.Referrals.Exceptions.NoClientResultException;
