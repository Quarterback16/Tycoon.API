...
namespace CQRSLiteDemo.Web.Commands.Requests.Locations
{
    ...
    public class AssignEmployeeToLocationRequestValidator 
      : AbstractValidator<AssignEmployeeToLocationRequest>
    {
           ...
           ILocationRepository locationRepo)
        {
            ...
            RuleFor(x => new { x.LocationID, x.EmployeeID })
               .Must(x => !locationRepo.HasEmployee(x.LocationID, x.EmployeeID))
