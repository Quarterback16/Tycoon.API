...
namespace CQRSLiteDemo.Web.Commands
{
    public class WebApiApplication : System.Web.HttpApplication
    {
        ...
        private void RegisterHandlers(IServiceLocator serviceLocator)
        {
            ...
            //By calling the line below, CQRSlite will register *all* Command Handlers 
            // in our project.  We don't need to explicitly register any additional ones. - MPJ 8/2/2016
