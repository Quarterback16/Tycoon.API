...
namespace RosterLib
{
	...
	public class MetricsBase
	{
		...
		public ArrayList Load( string seasonIn )
		{
			Season = seasonIn;
		...
		{
			if ( team.MetricsHt == null ) LoadTeam( team, team.TeamCode );
