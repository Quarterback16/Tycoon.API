...
namespace ProgramAssuranceTool.Infrastructure.Interfaces
{
    ...
    public interface IReportService
    {
        ...
        FileStreamResult ToRtfResult<T>(T report, string name) where T : ActiveReport;

        /// <summary>
        /// Convert a report to Csv
        /// </summary>
        /// <typeparam name="T">Type of report.</typeparam>
        /// <param name="report">Instance of report to convert.</param>
        /// <param name="name">Name of report.</param>
        /// <returns>The report as a Rtf file</returns>
        FileStreamResult ToTextResult<T>(T report, string name) where T : ActiveReport;
