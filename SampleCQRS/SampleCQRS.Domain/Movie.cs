...
namespace SampleCQRS.Domain
{
    public class Movie : AggregateRoot
    {
        ...
        protected void OnMovieCreated(
           MovieCreatedEvent domainEvent)
        {
        ...
        protected void OnMovieTitleChanged(
           MovieTitleChangedEvent domainEvent)
        {
            Title = domainEvent.Title;
        }

        protected void OnMovieReleaseDateChanged(
           MovieReleaseDateChangedEvent domainEvent)
        {
            ReleaseDate = domainEvent.ReleaseDate;
        }

        protected void OnMovieRunningTimeChanged(
           MovieRunningTimeChangedEvent domainEvent)
        {
            RunningTimeMinutes = domainEvent.RunningTimeMinutes;
        }
    }
